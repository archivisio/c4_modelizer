...
import { CloseButton, DragIcon, EmptyResults, EmptyText, ItemName, ItemType, ResultItem, ResultsContainer, SearchBarContainer, SearchField, SubtitleText, TitleBar, TitleText } from "./searchBarNodeStyled";
