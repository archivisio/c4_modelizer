...
const mockGetTechnologiesByLevel = getTechnologiesByLevel as jest.MockedFunction<typeof getTechnologiesByLevel>;

const mockTechnologies = [
  { id: 'react', name: 'React', icon: 'react', color: '#61dafb', levels: ['component', 'code'] },
  { id: 'node', name: 'Node.js', icon: 'nodejs', color: '#339933', levels: ['component', 'code'] },
];

const theme = createTheme();

const renderTechnologySelect = (props: Partial<React.ComponentProps<typeof TechnologySelect>> = {}) => {
  const defaultProps = {
